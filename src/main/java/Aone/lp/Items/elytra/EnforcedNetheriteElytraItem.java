...
public class EnforcedNetheriteElytraItem extends ArmorItem {

    public EnforcedNetheriteElytraItem(Properties properties) {
        super(ArmorMaterials.NETHERITE, Type.CHESTPLATE, properties.rarity(Rarity.EPIC));
    }
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        ...
        if (localPlayer.getItemBySlot(EquipmentSlot.CHEST).getItem() instanceof EnforcedNetheriteElytraItem) {
