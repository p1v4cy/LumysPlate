...
public class EnforcedIronElytraItem extends ArmorItem {

    public EnforcedIronElytraItem(Properties properties) {
        super(ArmorMaterials.IRON, Type.CHESTPLATE, properties.rarity(Rarity.RARE));
    }
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        ...
        if (localPlayer.getItemBySlot(EquipmentSlot.CHEST).getItem() instanceof EnforcedIronElytraItem) {
